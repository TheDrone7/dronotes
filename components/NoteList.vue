  ...
  <box mx="8" mt="12">
    ...
    >
      ...
      <box display="flex" align-items="center" justify-content="center" height="100%">
        <c-button as="nuxt-link" :to="'/user/note/' + note.id" variant-color="vue" variant="outline" font-weight="bold"
          >Edit</c-button
        >
        <c-button ml="4" variant-color="red" variant="outline" font-weight="bold" @click.prevent="deleteNote(note.id)"
          >Delete</c-button
        >
      </box>
    </pseudo-box>
